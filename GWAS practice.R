...
result <- read.csv("GAPIT.Association.GWAS_Results.MLM.EarHT(NYC).csv",  header = T)
head(result)

manhattan(result, main="Ear height", chr = "Chr", bp = "Pos", p = "P.value", snp = "SNP",           
          col = c("forestgreen", "lightpink"),           
...
getwd
getwd()
setwd("C:/Users/coope/OneDrive/Documents/GWAS")
getwd()

myGAPIT=GAPIT(
  Y=myY[,c(1,4)],      # Phenotypes: fist column is genotype ID and second is a phenotype
...
res <- read.csv("GAPIT.Association.GWAS_Results.MLM.EarDia(NYC).csv",  header = T)
head(res)

manhattan(res, main="Ear diameter", chr = "Chr", bp = "Pos", p = "P.value", snp = "SNP",           
          col = c("green", "magenta"),           
